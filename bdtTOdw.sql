...
Prompt **BDT TO DW : Insertions des donnï¿½es **
Prompt **BDT TO DW : Insertions des donnï¿½es : Table f_dw_date **
...
Prompt **BDT TO DW : Insertions des donnï¿½es : Table f_dw_product **
...
Prompt **BDT TO DW : Insertions des donnï¿½es : Table f_dw_clerk **
...
Prompt **BDT TO DW : Rï¿½activation des contraintes et tables exceptions **
Prompt **BDT TO DW : Insertions des donnï¿½es pour gï¿½rer les erreurs **
...
Prompt ** activation des clefs etrangï¿½res ** 
